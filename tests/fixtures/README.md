...
| `nodes2.txt` | Política de erro fatal para `Group` (com grupos aninhados e `set/push` de variáveis pós-`end_group`). Resultado esperado: erro "Script contém Group", warning de input externo no Stamp2. |
